...
@property (nonatomic) OAuthSwiftClient * __nonnull client;
...
@property (nonatomic, readonly) OAuthSwiftCredential * __nonnull credential;
@property (nonatomic) enum ParamsLocation paramsLocation;
- (nonnull instancetype)initWithConsumerKey:(NSString * __nonnull)consumerKey consumerSecret:(NSString * __nonnull)consumerSecret OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithConsumerKey:(NSString * __nonnull)consumerKey consumerSecret:(NSString * __nonnull)consumerSecret accessToken:(NSString * __nonnull)accessToken accessTokenSecret:(NSString * __nonnull)accessTokenSecret OBJC_DESIGNATED_INITIALIZER;
- (void)get:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * __nullable)headers success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (void)post:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * __nullable)headers success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (void)put:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * __nullable)headers success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (void)delete:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * __nullable)headers success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (void)patch:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * __nullable)headers success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (OAuthSwiftHTTPRequest * __nonnull)makeRequest:(NSURLRequest * __nonnull)request;
- (OAuthSwiftHTTPRequest * __nonnull)makeOAuthSwiftHTTPRequest:(OAuthSwiftHTTPRequest * __nonnull)request;
- (void)postImage:(NSString * __nonnull)urlString parameters:(NSDictionary<NSString *, id> * __nonnull)parameters image:(NSData * __nonnull)image success:(void (^ __nullable)(NSData * __nonnull, NSHTTPURLResponse * __nonnull))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
- (NSData * __nonnull)multiPartBodyFromParams:(NSDictionary<NSString *, id> * __nonnull)parameters boundary:(NSString * __nonnull)boundary;
@end
...
@property (nonatomic, copy) NSString * __nonnull oauth_refresh_token;
@property (nonatomic, copy) NSString * __nonnull oauth_token_secret;
@property (nonatomic) NSDate * __nullable oauth_token_expires_at;
@property (nonatomic, readonly, copy) NSString * __nonnull oauth_verifier;
...
+ (NSMutableURLRequest * __nullable)setupRequestForOAuth:(NSMutableURLRequest * __nonnull)request headers:(NSDictionary<NSString *, NSString *> * __nonnull)headers parameters:(NSDictionary<NSString *, id> * __nonnull)parameters dataEncoding:(NSUInteger)dataEncoding body:(NSData * __nullable)body paramsLocation:(enum ParamsLocation)paramsLocation error:(NSError * __nullable * __null_unspecified)error;
@end
...
@property (nonatomic, readonly) UIViewController * __nonnull viewController;
@property (nonatomic) BOOL animated;
@property (nonatomic, copy) SFSafariViewController * __nonnull (^ __nonnull factory)(NSURL * __nonnull);
@property (nonatomic) id <SFSafariViewControllerDelegate> __nullable delegate;
